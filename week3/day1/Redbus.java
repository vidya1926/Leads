...
Thread.sleep(1000);
 ...
 driver.findElement(By.xpath("//div[contains(@class,'sort-results w-80')]")).getText();
...
Thread.sleep(2000);
List<WebElement> allfare= (List<WebElement>) driver.findElementByXPath("//*[@id='root']/div/div[2]/div[2]/div[3]/div[6]/a/text()");
