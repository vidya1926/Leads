...
public class CreateContact {
    ...
    driver.findElement(By.id("createContactForm_birthDate")).sendKeys("5/25/1987");
    ...
    WebElement from= driver.findElement(By.id("createContactForm_generalCountryGeoId"));
    
      
    Select State=new Select(from);
	List<WebElement> city= State.getOptions();
	List<String> get = new  ArrayList<String>();
	for(int i=0;i<city.size();i++)
	{if(city.get(i).getText().startsWith("k"))
